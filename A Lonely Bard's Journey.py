...
def cavernOfBlood():
    if playerMarked and reflectedInPond:
        ...
        if choice == "1":
            ...
            sleep(1)
            narratorSays("With what little energy have left you struggle against the growing fatigue and push forward.")
            sleep(3)
            narratorSays("Each passing minute your strength wavers, you feel your body beginning to give in")
            sleep(2)
            importantSays("You feel heavy...")
            sleep(2)
            importantSays("Your limbs grow numb...")
            sleep(2)
            importantSays("As you crawl..scrape.. and claw your way forward")
            sleep(2)
            importantSays("You feel your body being tugged at from multiple angles as you now pull yourself past the sharp and jagged terrain.")
            sleep(1)
            importantSays("The sound of flesh ripping and meat spilling eachoes louder with each pull.")
            sleep(2)
            importantSays("Then you pause")
            sleep(3)
            importantSays("You catch a momentary glimpse of something.. in a water droplet falling from above.")
            sleep(2)
            importantSays("You do not move... you do not breath... for fear that what you just saw would be your reality.")
            importantSays("...")
            sleep(2)
            importantSays("You give in")
            sleep(2)
            importantSays("And stay still...")
            sleep(3)
            ...
            narratorSays("...") 
            importantSays("Then you feel it.")
            sleep(2)
            importantSays("Your warped flesh begins to bubble and shift uncontrollably.")
            sleep(1)
            importantSays("You try to scream, but no sound escapes your lips as your skin and muscle slough off your body.")
            sleep(1)
            importantSays("Within moments, you are nothing more than a sick pile of blood and meat")
            sleep(1)
            importantSays("As you lose consciousness, you feel the creatures sick and twisted desires rage forward from your very core.")
            sleep(1)
            importantSays("Your conscience fades as it greedily consumes your remains.")
            sleep(2)
            importantSays("You were dead the moment it learned of your existence.")
            sleep(1)
            simpleGameOver()
        ...
        if choice == "1":
            ...
            continuePrompt()
            sleep(2)
            narratorSays("Suddenly your legs give in and you collapse to the ground.")
            sleep(1)
            narratorSays("Just the thought of moving again causes exhaustion so you take a moment to rest before pushing forward.")
            narratorSays("...")
            sleep(2)
            narratorSays("As you head deeper into the cavern, you feel a wave of nausea wash over you.")
            sleep(1)
            importantSays("The sound of bones crunching and flesh tearing fills the cavern causing you to fall back in fear.")
            sleep(2)
            importantSays("You clasp your ears tightly, trying to block out the horrific sounds, but they only grow louder.")
            sleep(2)
            importantSays("As you struggle to suprress the rising panic within you, you feel a cold hand grip your shoulder.")
            sleep(1)
            importantSays("You turn around slowly, your heart ready to leave this world.")
            sleep(2)
